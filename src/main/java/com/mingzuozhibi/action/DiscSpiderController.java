...
import com.mingzuozhibi.modules.disc.spider.DiscSpider;
import com.mingzuozhibi.modules.disc.spider.DiscUpdate;
import com.mingzuozhibi.modules.disc.spider.SearchTask;
...
public class DiscSpiderController extends BaseController {
    ...
    private String searchDiscFromAmazon(@PathVariable String asin) {
        ...
        jmsMessage.success(CheckUtils.doCreate("碟片", disc.getTitle(), asin));
